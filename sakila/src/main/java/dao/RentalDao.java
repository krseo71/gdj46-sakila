...
public class RentalDao {
	...
	public List<Rental> selectRentalList(int beginRow, int rowPerPage) {
		...
		conn = DBUtil.getConnection();
		// 쿼리문 작성
		String sql = "SELECT rental_id rentalId," + "		 rental_date rentalDate,"
				+ "		inventory_id inventoryId," + "		customer_id customerId," + "		return_date returnDate,"
				+ "		staff_id staffId," + "		last_update lastUpdate" + "	FROM rental" + "	LIMIT ?,? ";
		try {
			stmt = conn.prepareStatement(sql);
