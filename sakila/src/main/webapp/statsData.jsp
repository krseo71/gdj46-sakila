...
<%
	...
	//10.나라별 가장 선호하는 영화(중복허용)
	List<Map<String,Object>> mostFilmByCountry = statsDataDao.mostFilmByCountry();
%>
<!DOCTYPE html>
<html>
<head>
...
<body class="container">
	...
	<!--  -->
		<h2>9.store 매장별  요일별 매출(월화수목금토일) 1주만</h2>
			<table class="table table-bordered">
				<thead>
					<th>store</th>
					<th>day</th>
