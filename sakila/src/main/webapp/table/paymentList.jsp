...
<%
	...
	//list 정보 호출
	List<Payment> paymentList = paymentDao.selectPaymentList(beginRow, rowPerPage);
	
	//전체 행의 수 값 호출
	totalRow = paymentDao.totalRow();
...
<body class="container">
	...
	<!-- 페이지 목록 표시 부분 -->
	<form method ="get" action = "<%=request.getContextPath()%>/table/paymentList.jsp">
		<!-- 이전 목록 표시 -->
		<%
			if(minPage > 10){
		 %>
